...
use statikbe\export\variables\ExportVariable;
use yii\base\Event;
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'export/default';
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('export', ExportVariable::class);
            }
        );
            ...
            function (PluginEvent $event) {
                if ($event->plugin === $this) {
                    if (Craft::$app->request->isCpRequest) {
                        Craft::$app->getResponse()->redirect(UrlHelper::cpUrl('export/welcome'))->send();
                    }
                }
            }
        );
